        ...
        {state.todos.map(todo => (
          ...
          >
            <span
              ...
              onDoubleClick={async () => {
                const response = await Axios.patch(`https://hooks-api.fuchienhsu12.now.sh/todos/${todo.id}`, {
            ...
            <button
              onClick={async () => {
                await Axios.delete(`https://hooks-api.fuchienhsu12.now.sh/todos/${todo.id}`)
